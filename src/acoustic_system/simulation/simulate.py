...
class Simulate:
    def __init__(self, grid_shape=(100, 100), drivers=None, sensors=None, wavespeed=1.0):
        """
    ...
    def step(self):
        ...
        p_next = 2 * self.p - self.p_prev + self.wavespeed**2 * laplacian
        ...
        # Advance time
        self.time += 1 # Using a simplified time step of 1 for now